// The puzzle the document used to paste in above this file as a bare global.
// window.scmsJSON.lettergrid is one string per row, and it is read at ready
// because the CMS assigns scmsJSON at the end of [head], after this file's own
// tag has run.
var lettergrid;
...
$(document).ready(function () {
    lettergrid = (window.scmsJSON && window.scmsJSON.lettergrid) || lettergrid;
    createLetterGrid();
});
